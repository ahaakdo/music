package com.melody.music.controller;

import com.alibaba.fastjson.JSONObject;
import com.melody.music.pojo.Singer;
import com.melody.music.pojo.SongList;
import com.melody.music.service.SongListService;
import com.melody.music.utils.Consts;
...
public class SongListController {
     ...
     * 根据主键查询歌单名
     */
    @ApiOperation(value = "根据主键查询歌单名")
    @RequestMapping(value = "/selectSongListTitleById",method = RequestMethod.GET)
    public String selectSongListTitleById(HttpServletRequest request){
        String id = request.getParameter("id").trim();          //主键
        System.out.println("id="+id);
        return songListService.selectSongListTitleById(Integer.parseInt(id));
    }
    ...
    public Object addSongList(HttpServletRequest request){
        ...
        if(flag){   //保存成功
            ...
            // 获取新插入的歌手信息，包括 ID
            SongList newSongList = songListService.selectByPrimaryKey(songList.getId());
            jsonObject.put("songList", newSongList);
            return jsonObject;
        }
     ...
     * 所有歌曲排行榜
     */
    @ApiOperation(value = "所有歌曲排行榜")
    @RequestMapping(value = "/phallSongList",method = RequestMethod.GET)
    public Object PhSongList(HttpServletRequest request){
        List<SongList> list=songListService.phlist();
        return list;
    }

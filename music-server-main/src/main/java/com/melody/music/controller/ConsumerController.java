...
import com.melody.music.pojo.Consumer;
import com.melody.music.service.ConsumerService;
...
public class ConsumerController {
    ...
    public Object addConsumer(HttpServletRequest request){
        ...
        if(flag){   //保存成功
            ...
            Consumer newConsumer = consumerService.selectByPrimaryKey(consumer.getId());
            jsonObject.put("consumer", newConsumer);
            return jsonObject;
        }
        jsonObject.put(Consts.CODE,0);

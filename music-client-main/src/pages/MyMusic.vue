<template>
    <div class="my-music">
        ...
        <div class="album-content">
            ...
            <div>
                <comment-content :userCommentList="userCommentList">
                    <template slot="title">我的评论</template>
                </comment-content>
            </div>
        </div>
    </div>
...
import {getUserOfId,getCollectOfUserId,songOfSongId, getUserAllComment} from '../api/index';

...
// 查询歌单排行榜
export const getSongListOrder = () => get(`/songList/phallSongList`)
//根据id查找歌单名称
export const getSongListTitleById = (id) => {
  return get(`songList/selectSongListTitleById?id=${id}`);
}
...
//返回当前用户的所有评论
export const getUserAllComment = (userId) => {
  return get(`/comment/selectByUserId?userId=${userId}`);
}
//删除评论
